<head>
    <title>@yield('title') | karlm.dev</title>
...
<body>
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="/">karlm.dev</a>
    ...
    <div class="footer-row">
        <div class="footer-row-item">
            <h4>Contact Info :</h4>
            <a href="mailto:karl@karlm.dev">karl@karlm.dev</a> &nbsp;
        </div>
        <div class="footer-row-item">
            <h4>Quick Links :</h4>
            <a href="https://twitter.com/karlplayswell" target="_blank"><i class="fab fa-twitter-square"></i></a>&nbsp;
    ...
    <footer>
        <div class="footer">
            ...
            <div class="credit">&copy; 2019 karlm.dev</div>
        </div>
    </footer>
</body>